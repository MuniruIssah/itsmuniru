import { SiAngular, SiAstro, SiDocker, SiDotnet, SiExpo, SiExpress, SiGit, SiGithub, SiMongodb, SiNextdotjs, SiPython, SiReact, SiReactrouter, SiRedis, SiSlack, SiSupabase, SiTailwindcss, SiTypescript } from "react-icons/si";
...
const experience = [
  ...
  },
  {
    ...
    description: 'As a utility developer, I was responsible for developing and maintaining over six applications — ranging from internal tools that streamlined operations to customer-facing platforms that generated revenue for the bank.',
    technologies: [
      { label: 'React', icon: <SiReact /> },
      { label: 'React Native', icon: <TbBrandReactNative /> },
      { label: 'Tailwind CSS', icon: <SiTailwindcss /> },
  ...
  },
  {
    ...
    description: 'Collaborated with the team to develop and maintain the company’s dashboards and backend services, ensuring reliability and performance across core systems.',
    technologies: [
      { label: 'React', icon: <SiReact /> },
      { label: 'Node.js', icon: <FaNodeJs /> },
      { label: 'Express', icon: <SiExpress /> },
...
const projects = [
  {
    ...
    description: 'A suite of web applications designed to support the management of patients with chronic conditions. This included a patient onboarding portal, an admin dashboard, a clinical trial site, and a sponsor portal.',
    roles: [
  ...
  },
  {
    ...
    description: 'TrialViu is a HIPAA-compliant platform powered by Viuhealth and plays a critical role in connecting people living with autoimmune conditions to relevant clinical trials.',
    roles: [
...

  {
    ...
    description: 'The team at Viuhealth collaborated with LOKA, to build an extraction and matching algorithm, which leveraged the power of LLMs to automatically assess the likelihood of a specific patient being accepted to a clinical trial based on the trial\'s eligibility criteria.',
    roles: [
  ...
  },
  {
    ...
    description: 'An events ecosystem that enables organizers to create and manage events, while end users can pay through a client-facing web application, embeddable widget, or USSD long code. It also includes an internal administrative portal for managing event organizers.',
    roles: [
...

  {
    ...
    description: 'Myghpay is the safest and most robust online payment and collections platform designed to enable individuals, businesses and institutions to make or receive payments online, from the comfort of their homes, offices and on-the-go.',
    roles: [
  ...
  },
  {
    ...
    description: 'The Internet Banking Self Onboarding is an application that allows customers to onboard to the bank\'s internet banking service by themselves.',
    roles: [
  ...
  },
  {
    ...
    description: 'Myghpay Checkout is a payment gateway for merchants to accept payments from their customers.',
    roles: [
...
export { currentStack, experience, projects }